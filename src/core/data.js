...
export const _VNO_SEED={
  BOM:{SF:1,SH:1,SC:1,SV:1,SHT:1,SI:1,SM:1,PF:1,PH:1,PHT:1,PV:1,PC:1,PI:1,PM:1,RV:1,PMT:1,CV:1,JV:1,DB:1,BR:1,RF:1,RI:1},
  AMD:{SF:1,SH:1,SC:1,SV:1,SHT:1,SI:1,SM:1,PF:1,PH:1,PHT:1,PV:1,PC:1,PI:1,PM:1,RV:1,PMT:1,CV:1,JV:1,DB:1,BR:1,RF:1,RI:1},
};
...
export const TAX_ALL = {label:"Taxation", icon:FileText, _regime:"ALL", children:[
  ...
  {divider:true, label:"TK Group Central"},
  {label:"Compliance Calendar",       href:"/tax/calendar"},
  /* — Tax & Statutory (moved here from the Accounts pill) — */
  {divider:true, label:"Tax & Statutory"},
  {label:"GST / VAT Summary (Return)", href:"/reports/tax-summary"},
...
export const ROUTE_TITLES={
  ...
  "/group-dashboard":       "Group Executive Dashboard — TK Group Central",
  ...
  "/reports/consolidated-bs":"Consolidated Balance Sheet — TK Group Central",
