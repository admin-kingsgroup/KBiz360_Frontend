...
import {
  ...
  MENU_ACCOUNTS, MENU_DASHBOARDS, MENU_IMPORT_EXPORT, MENU_APPROVALS, MENU_RECONCILIATION,
} from './menus';
...
const ROOTS = [
  MENU_ACCOUNTS, MENU_RECONCILIATION, MENU_DASHBOARDS, MENU_FINANCE, MENU_REPORTS, MENU_MASTERS, MENU_HR, MENU_SETTINGS,
