...
// Import through the reportsFinancial shim (not the direct sibling file) —
// adjustWholeBook.test.jsx and ageingConsolidatedRender.test.jsx mock
// '../outstanding' (relative to reportsFinancial/__tests__/) to isolate
// ArApScreen from the live Outstanding screen; a direct sibling import would
// bypass that mock boundary.
import { OutstandingOnAccount } from '../../reportsFinancial/outstanding';
