...
// Import through the reportsFinancial barrel (not the direct sibling file) —
// tests (balanceSheetUnifiedViews.test.jsx) mock '../reportsFinancial' to
// isolate this screen from the live data/api stack; a direct sibling import
// would bypass that mock boundary.
