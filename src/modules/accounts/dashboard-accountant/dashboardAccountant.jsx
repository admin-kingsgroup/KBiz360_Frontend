/* ════════════════════════════════════════════════════════════════════
   DASHBOARD ACCOUNTANT  /accounts/dashboard
   Lets a branch accountant operate their whole day from one place. All data
   is REUSED from existing endpoints (ageing, registers, approvals, trial
   balance, tax) — this screen composes & focuses that data; it posts
   nothing new. Branch-scoped via the top-right selector.

   BUSINESS SUB-MODULE REORG (2026-07-13): moved out of
   accountantWorkspace/accountantWorkspace.jsx (MENU_ACCOUNTS top-level leaf
   "Dashboard Accountant"). accountantWorkspace/index.js re-exports this (and
   ymOf/groupBalance, tested directly) from here.
   ════════════════════════════════════════════════════════════════════ */
...
import { C, card, money, brLabel, thisYM, Shell, th, td, rnum, Table, aBtn, Tile, SecTitle, Row } from '../../accountantWorkspace/shared';
...
// Dead code: not referenced anywhere (not even destructured in App.jsx) —
// retired, kept for reference only. Depends on AgeingTable (private helper
// above, defined for DashboardAccountant), so co-located here rather than
