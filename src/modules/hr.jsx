  ...
  return (
    <div style={{padding:"12px 10px",maxWidth:1200,margin:"0 auto"}}>
      ...
      <div style={{display:"flex",gap:6,marginBottom:10}}>
        <button onClick={()=>setView("monthly")} style={{padding:"6px 10px",border:"none",cursor:"pointer",fontSize:11,fontWeight:view==="monthly"?700:500,background:view==="monthly"?"#0d1326":"transparent",color:view==="monthly"?"#d4a437":"#5a6691",borderRadius:6}}>Monthly Budget</button><button onClick={()=>setView("yearly")} style={{padding:"6px 10px",border:"none",cursor:"pointer",fontSize:11,fontWeight:view==="yearly"?700:500,background:view==="yearly"?"#0d1326":"transparent",color:view==="yearly"?"#d4a437":"#5a6691",borderRadius:6}}>Yearly Budget</button><button onClick={()=>setView("actuals")} style={{padding:"6px 10px",border:"none",cursor:"pointer",fontSize:11,fontWeight:view==="actuals"?700:500,background:view==="actuals"?"#0d1326":"transparent",color:view==="actuals"?"#d4a437":"#5a6691",borderRadius:6}}>Actuals</button>
      </div>
