...
// A read-only scoreboard: how much of the control layer is engaged (green %), whether any
// control is enforcing, and each control's on/off state — from the live flag state. The
// number Faiz & the Owner watch climb to 100% as go-live completes. Complements (does not
// duplicate) the Go-Live activation checklist.
const COLS = [
  ...
  return (
    <div className="grid gap-4">
      <div className="flex flex-wrap items-center gap-8">
        ...
        <div>
          <div className="text-[10px] font-bold uppercase tracking-wide text-ink-subtle">Enforcement</div>
          <div className="mt-1">
            {r.anyOn
              ? <Badge tone="success">Engaged · enforcing</Badge>
              : <Badge tone="warning">Dormant · defaults only</Badge>}
          </div>
        </div>
      </div>
