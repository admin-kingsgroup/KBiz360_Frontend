...
function makeBookingSpec(code) {
  ...
  const header = ['Link No', 'Branch', 'Date', sp.headerLabel, 'Customer Name', 'Customer Ledger', 'Customer Sub-Group', 'Supplier Name', 'Supplier Ledger', 'Supplier Sub-Group', ...(hasPkg ? ['Package Type'] : []), 'GST Mode', 'Without VAT'];
  ...
  const exHeader = ['BKL-0001', 'BOM', '2025-06-18', BOOKING_HEADER_SAMPLE[code], 'Global Konnection', 'Global Konnection', 'B2B Clients', supName, supName, supGrp, ...(hasPkg ? ['Domestic'] : []), 'intra', 'No'];
