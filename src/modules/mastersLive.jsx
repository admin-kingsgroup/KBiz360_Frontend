...
export const GroupsMaster = ({ branch }) => {
  ...
  return (
    <PageLayout
      ...
      subtitle={`Tally Parent ▸ Tally Sub ▸ ERP Group ▸ ERP Sub Group ▸ ERP Ledger · ${rows.length} rows · ${subGroupCount} sub-groups · ${ledgers.length} ledgers${branchView !== 'ALL' ? ` (${branchView} + Common)` : ''}`}
      actions={
        <>
