/* ════════════════════════════════════════════════════════════════════════════
   ...
   superseded by BookingApprovals, kept for reference only. BookingApprovals
   is used by modules/approvals/voucherApprovals.jsx (the separate top-level
   Approvals nav module, not Accounts) — stays here, out of scope for the
   Accounts business-module reorg.
...
import {
  Plus, Trash2, Save, Check, RefreshCw, Clock, CheckCircle2,
  XCircle, ChevronDown, ChevronRight, FileCheck2, Pencil, RotateCcw, FileEdit,
} from 'lucide-react';
