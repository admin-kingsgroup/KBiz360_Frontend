...
export const DEV_REGISTRY = [
  {
    ...
    items: [
      ...
      { name: 'Trial Balance (Opening/Debit/Credit/Closing)', status: 'live', modules: ['accounting'], routes: ['/finance/trial-balance'], api: ['/api/accounting'], note: 'Migrated page with ledger-drill (openLedgerModal); legacy /trial-balance now redirects here. Backend restart required after trialBalance controller changes.' },
